...
# Review of Indicators: ENPOVE 2018 vs ENPOVE 2022  

```{r  df_household_preprocessing}
##Preprocessing

#ENPOVE 2022
df_household_enpove2022 <- read_sav(here::here("data-raw","ENPOVE2022_V_100 Características de la vivienda y del hogar.sav"))
...
df_household_enpove2022a <- df_household_enpove2022 

######## CREATE PCODE AT ADMIN 3 LEVEL. ONLY USED FOR ENPOVE 2022
df_household_enpove2022 <- df_household_enpove2022  |>
...
```{r  df_household_enpove2022_indicator}
...
df_household_enpove2022 <- df_household_enpove2022 |>
          dplyr::mutate(drinking_water = dplyr::case_when(
            P108_1 == 1 ~ 1,   TRUE ~ 0   ) )
df_household_enpove2022$drinking_water  <- labelled::labelled(df_household_enpove2022$drinking_water,
  labels = c( 'Deprived' = 0, 'Not Deprived' = 1 ),
  label = "Living Standards | Drinking water")

plot_indic(indic = df_household_enpove2022$drinking_water,
                       cross = df_household_enpove2022$class,
                       weight = df_household_enpove2022$factorfinal)
 
deprivation_profile$drinking_water <- df_household_enpove2022 |>
  define_deprivation(
...
#             P108_1 < 3 ~ 1,   TRUE ~ 0   ) )
# df_household_enpove2022$drinking_waterv2  <- labelled::labelled(df_household_enpove2022$drinking_waterv2,
#   labels = c( 'Deprived' = 0, 'Not Deprived' = 1 ),
...
df_household_enpove2022 <- df_household_enpove2022 |>
          dplyr::mutate(sanitation = dplyr::case_when(
            P108_2 == 1 ~ 1,   TRUE ~ 0   ) )
df_household_enpove2022$sanitation  <- labelled::labelled(df_household_enpove2022$sanitation,
  labels = c( 'Deprived' = 0, 'Not Deprived' = 1 ),
  label = "Living Standards |	Sanitation")


plot_indic(indic = df_household_enpove2022$sanitation,
                       cross = df_household_enpove2022$class,
                       weight = df_household_enpove2022$factorfinal)

deprivation_profile$sanitation <- df_household_enpove2022 |>
  define_deprivation(
...
#             P108_2 < 3 ~ 1,   TRUE ~ 0   ) )
# df_household_enpove2022$sanitationv2  <- labelled::labelled(df_household_enpove2022$sanitationv2,
#   labels = c( 'Deprived' = 0, 'Not Deprived' = 1 ),
...
df_household_enpove2022 <- df_household_enpove2022 |>
          dplyr::mutate(electricity = dplyr::case_when(
            P108_3 == 1 ~ 1,   TRUE ~ 0   ) )
df_household_enpove2022$electricity  <- labelled::labelled(df_household_enpove2022$electricity,
  labels = c( 'Deprived' = 0, 'Not Deprived' = 1 ),
  label = "Living Standards |	Electricity")


plot_indic(indic = df_household_enpove2022$electricity,
                       cross = df_household_enpove2022$class,
                       weight = df_household_enpove2022$factorfinal)

deprivation_profile$electricity <- df_household_enpove2022 |>
  define_deprivation(
...
df_household_enpove2022$ind04_01  <- labelled::labelled(df_household_enpove2022$ind04_01,
  labels = c( 'Deprived' = 0, 'Not Deprived' = 1 ),
...
df_household_enpove2022$ind04_02  <- labelled::labelled(df_household_enpove2022$ind04_02,
  labels = c( 'Deprived' = 0, 'Not Deprived' = 1 ),
...
df_household_enpove2022$ind04_02v2  <- labelled::labelled(df_household_enpove2022$ind04_02v2,
  labels = c( 'Deprived' = 0, 'Not Deprived' = 1 ),
...
df_household_enpove2022 <- df_household_enpove2022 |>
          dplyr::mutate(ind04_02v3 = dplyr::case_when(
            P102 == 1 ~ 1,   TRUE ~ 0   ) )
df_household_enpove2022$ind04_02v3  <- labelled::labelled(df_household_enpove2022$ind04_02v3,
  labels = c( 'Deprived' = 0, 'Not Deprived' = 1 ),
...
df_household_enpove2022$ind04_03  <- labelled::labelled(df_household_enpove2022$ind04_03,
  labels = c( 'Deprived' = 0, 'Not Deprived' = 1 ),
...
df_household_enpove2022$ind04_03v2  <- labelled::labelled(df_household_enpove2022$ind04_03v2,
  labels = c( 'Deprived' = 0, 'Not Deprived' = 1 ),
...
df_household_enpove2022 <- df_household_enpove2022 |>
          dplyr::mutate(housing = dplyr::case_when(
            ...
            TRUE ~ 0   ) )
df_household_enpove2022$housing  <- labelled::labelled(df_household_enpove2022$housing,
  labels = c( 'Deprived' = 0, 'Not Deprived' = 1 ),
  label = "Living Standards | Adequate	Housing (floor, roof, walls)")


plot_indic(indic = df_household_enpove2022$housing,
                       cross = df_household_enpove2022$class,
                       weight = df_household_enpove2022$factorfinal)
...
deprivation_profile$housing <- df_household_enpove2022 |>
  define_deprivation(
    .indicator = housing,
    .cutoff = housing == 1
  )
...
df_household_enpove2022$ind04_04  <- labelled::labelled(df_household_enpove2022$ind04_04,
  labels = c( 'Deprived' = 0, 'Not Deprived' = 1 ),
...
df_household_enpove2022$ind04_04v2  <- labelled::labelled(df_household_enpove2022$ind04_04v2,
  labels = c( 'Deprived' = 0, 'Not Deprived' = 1 ),
...
df_household_enpove2022$cooking_fuel  <- labelled::labelled(df_household_enpove2022$cooking_fuel,
  labels = c( 'Deprived' = 0, 'Not Deprived' = 1 ),
  label = "Living Standards |	Cooking fuel")


plot_indic(indic = df_household_enpove2022$cooking_fuel,
                       cross = df_household_enpove2022$class,
                       weight = df_household_enpove2022$factorfinal)

deprivation_profile$cooking_fuel <- df_household_enpove2022 |>
  define_deprivation(
...
df_household_enpove2022 <- df_household_enpove2022 |>
          dplyr::mutate(assets = dplyr::case_when(
            P110 > 2 ~ 1,   TRUE ~ 0   ) )
df_household_enpove2022$assets  <- labelled::labelled(df_household_enpove2022$assets,
  labels = c( 'Deprived' = 0, 'Not Deprived' = 1 ),
  label = "Living Standards |	Assets (does not owns 3 or more esential items)") 


plot_indic(indic = df_household_enpove2022$assets,
                       cross = df_household_enpove2022$class,
                       weight = df_household_enpove2022$factorfinal)

deprivation_profile$assets <- df_household_enpove2022 |>
  define_deprivation(
    .indicator = assets,
    .cutoff = P110 <=2
  )
...
df_household_enpove2022 <- df_household_enpove2022 |>
          dplyr::mutate(assetsv2 = dplyr::case_when(
            P110 > 3 ~ 1,   TRUE ~ 0   ) )
df_household_enpove2022$assetsv2  <- labelled::labelled(df_household_enpove2022$assetsv2,
  labels = c( 'Deprived' = 0, 'Not Deprived' = 1 ),
  label = "Living Standards |	Assets (does not owns 2 or more items)") 


# plot_indic(indic = df_household_enpove2022$assetsv2, 
#                        cross = df_household_enpove2022$class, 
#                        weight = df_household_enpove2022$factorfinal)
...
df_household_enpove2022$ind04_07  <- labelled::labelled(df_household_enpove2022$ind04_07,
  labels = c( 'Deprived' = 0, 'Not Deprived' = 1 ),
  label = "Acceptable Accomodation type") 


plot_indic(indic = df_household_enpove2022$ind04_07,
                       cross = df_household_enpove2022$class,
                       weight = df_household_enpove2022$factorfinal)
...
```{r HogarViz, eval=FALSE}

cross <- c("CIUDAD")
crosslab <- "CIUDAD"
# dput(names(df_household))
data <- df_household_enpove2022 |>
...
plot_mpi <- function(mpi, cross, weight){
  ...
  p <- sjPlot::plot_grpfrq(var.cnt = mpi,
                    ...
                    show.n = FALSE) + 
    # adjut the scale
   # scale_x_discrete( n.breaks = 10 #breaks = waiver()
   #                   ) +
  ## and the chart labels
    ...
    if(lengths(data_roster.val[i]) > 0) {
      ...
      p <-   sjPlot::plot_xtab(x= data_roster[[i]],
        ...
        labs(title = stringr::str_wrap(paste0(varlab) , 70),
             ...
             x = "",
             y = "",
             caption = "Source: ENPOVE inei.gob.pe microdatos")
    } else {
...
df_household2 <- df_household |>
  dplyr::left_join( mpi_deprivation_matrix_uncensored |> dplyr::select(uuid, deprivation_score ), by = c("uuid"))
## Index but not weighted
# mpi_result$index

df_household2$deprivation_score  <- labelled::labelled(df_household2$deprivation_score,
  label = "Deprivation Score")


plot_mpi(mpi = df_household2$deprivation_score, 
        cross = df_household2$class, 
        weight = df_household2$factorfinal)
...
#The structure for ENPOVE 2018 is a bit different from ENPOVE 2022. No integrated database. The IDs for household and individuals have already been create and some extra preprocessing needs to be done in order to have the same fields as in ENPOVE 2022

#Loading ENPOVE 2018
df_household_1 <- read_sav(here::here("data-raw","ENPOVE_Capitulo 100 - Carctaerísticas de la Vivienda y del Hogar.sav.sav"))

df_household_2 <- read_sav(here::here("data-raw","ENPOVE_Capitulo 200 - Carctaerísticas de los Residentes del Hogar.sav.sav"))

#df_household_3 <- read_sav(here::here("data-raw","ENPOVE_Capitulo 300 - Situación Migratoria de la Persona.sav.sav"))

df_household_4 <- read_sav(here::here("data-raw","ENPOVE_Capitulo 400 - Salud.sav.sav"))

df_household_5 <- read_sav(here::here("data-raw","ENPOVE_Capitulo 500 - Educación.sav.sav"))

df_household_6 <- read_sav(here::here("data-raw","ENPOVE_Capitulo 600 - Empleo.sav.sav"))

######## DEPURACIÓN DE FILAS 

# We filter out of the analysis the homes where the survey was not completed.
df_household_1 <- df_household_1  |>
  rename(filter = `filter_$`)|>
  dplyr::filter(RESULTADO_FINAL_VIVIENDA == 1)

#when more than one household shares a residence the questions related to housing conditions are omitted and only registered for the first household. Then this information is filled for every household within the residence using "CODIGO_VIVIENDA"
df_household_1 <- df_household_1  |>
  group_by(CODIGO_VIVIENDA) |>
  mutate(P101 = ifelse(is.na(P101), na.omit(P101)[1], P101)) |>
  mutate(P102 = ifelse(is.na(P102), na.omit(P102)[1], P102)) |>
  mutate(P103 = ifelse(is.na(P103), na.omit(P103)[1], P103)) |>
  mutate(P104 = ifelse(is.na(P104), na.omit(P104)[1], P104)) |>
  mutate(P105 = ifelse(is.na(P105), na.omit(P105)[1], P105)) |>
  mutate(P106 = ifelse(is.na(P106), na.omit(P106)[1], P106)) |>
  mutate(P107 = ifelse(is.na(P107), na.omit(P107)[1], P107)) |>
  mutate(P105N = ifelse(is.na(P105N),na.omit(P105N)[1], P105N)) |> # this line fills the NA's this calculation that discretizes the number of rooms
  ungroup()

#bringing back the lost labels 
columns_to_label <- c("P101", "P102", "P103", "P104", "P105", "P106", "P107", "P105N")
for (col in columns_to_label) {
  df_household_1[[col]] <- labelled::labelled(df_household_1[[col]], label = switch(
    col,
    P101 = "TIPO DE VIVIENDA:",
    P102 = "¿EL MATERIAL DE CONSTRUCCIÓN PREDOMINANTE EN LAS PAREDES EXTERIORES ES:",
    P103 = "¿EL MATERIAL DE CONSTRUCCIÓN PREDOMINANTE EN LOS TECHOS ES:",
    P104 = "¿EL MATERIAL DE CONSTRUCCIÓN PREDOMINANTE EN LOS PISOS ES:",
    P105 = "¿CUÁNTAS HABITACIONES EN TOTAL TIENE LA VIVIENDA, SIN CONTAR EL BAÑO, LA COCINA, LOS PASADIZOS Y GARAGE?",
    P106 = "¿CUÁNTAS HABITACIONES SE USAN EXCLUSIVAMENTE PARA DORMIR?",
    P107 = "¿CUÁNTOS GRUPOS DE PERSONAS, INCLUYENDO EL SUYO; COMPARTEN ESTA VIVIENDA PERO COCINAN SUS ALIMENTOS POR SEPARADO?",
    P105N = "NUMERO DE HABITACIONES DE LA VIVIENDA"
  ))
}

#recode for P207: ¿MIGRÓ DE VENEZUELA?
df_household_2 <- df_household_2  |>
  dplyr::mutate(P207 = ifelse(P207==2,0,P207))

df_household_2a <- df_household_2 

#recode of CIUDADES DE ESTUDIO
recode_cities<-function(df) { 
  df <- df |>
  mutate(CIUDADES_DE_ESTUDIO = recode(CIUDADES_DE_ESTUDIO, 
                                      '1' = 'Lima Norte',
                                      '2' = 'Lima Este',
                                      '3' = 'Lima Centro',
                                      '4' = 'Lima Sur',
                                      ...
                                      '8' = 'Trujillo',
                                      '9' = 'Tumbes'))
  df$CIUDADES_DE_ESTUDIO <- labelled::labelled(df$CIUDADES_DE_ESTUDIO, label = "CIUDADES DE ESTUDIO")
  return(df)
  }

df_household_1 <- recode_cities(df_household_1)
df_household_2a <- recode_cities(df_household_2a)
df_household_4 <- recode_cities(df_household_4)
df_household_5 <- recode_cities(df_household_5)
df_household_6 <- recode_cities(df_household_6)

#group by household to create the variables for Total number of household members and Total number of venezuelan household members
df_household_2 <- df_household_2  |>
  group_by(CODIGO_HOGAR)  |>
  summarise(P15_N = n(),
            P207_sum = sum(P207, na.rm = TRUE),
            #nmiembros_recod = max(nmiembrosrecod,na.rm = TRUE),
            #P105_recod = max(P105C,na.rm = TRUE),
            #P106_recod = max(p106uso,na.rm = TRUE)
            )
df_household_2$P15_N  <- labelled::labelled(df_household_2$P15_N,
  label = "P15_N. Total number of household members")
df_household_2$P207_sum  <- labelled::labelled(df_household_2$P207_sum,
  label = "P207_sum. Total number of venezuelan household members")

# Function to rename the Household id's in each dataframe
rename_uuid <- function(df) {
  df <- df |>
    rename(uuid = CODIGO_HOGAR)
    if ("CIUDADES_DE_ESTUDIO" %in% colnames(df)) {
      df <- df |>
      rename(CIUDAD = CIUDADES_DE_ESTUDIO)
  }
  return(df)
}

# Applying the function to each dataframe
df_household_1 <- rename_uuid(df_household_1)
df_household_2 <- rename_uuid(df_household_2)
df_household_2a <- rename_uuid(df_household_2a)
df_household_4 <- rename_uuid(df_household_4)
df_household_5 <- rename_uuid(df_household_5)
df_household_6 <- rename_uuid(df_household_6)

#merge data at the household level
df_household <- merge(df_household_1, df_household_2, by = "uuid")

#### Filtramos fuera del análisis las personas que no migraron de Venezuela*.
df_household_2a <- df_household_2a  |>
  filter(P207 == 1)

# Extract common and unique column names
common_cols <- Reduce(intersect, lapply(list(names(df_household_2a), names(df_household_4), names(df_household_5), names(df_household_6)), as.vector))

diff_cols_df2a <- setdiff(names(df_household_2a), common_cols)
diff_cols_df4 <- setdiff(names(df_household_4), common_cols)
diff_cols_df5 <- setdiff(names(df_household_5), common_cols)
diff_cols_df6 <- setdiff(names(df_household_6), common_cols)

# Select only unique columns from each dataframe along with the key variable
df2a_unique <- df_household_2a %>%
  select(all_of(c(diff_cols_df2a, "CODIGO_PERSONA")))
df4_unique <- df_household_4 %>%
  select(all_of(c(diff_cols_df4, "CODIGO_PERSONA")))
df5_unique <- df_household_5 %>%
  select(all_of(c(diff_cols_df5, "CODIGO_PERSONA")))
df6_unique <- df_household_6 %>%
  select(all_of(c(diff_cols_df6, "CODIGO_PERSONA")))

# Merge dataframes based on the key "CODIGO_PERSONA" and add columns with different names
df_household_roster <- df_household_2a %>%
  left_join(df4_unique, by = "CODIGO_PERSONA") %>%
  left_join(df5_unique, by = "CODIGO_PERSONA") %>%
  left_join(df6_unique, by = "CODIGO_PERSONA")

# Rename variables
df_household <- df_household |>
  rename(factorfinal = FACTOR_DE_EXPANSION,
         Ubigeo = UBIGEO)
...
# Household ENPOVE 2018

```{r  df_household_indicator_enpove2018}
...
#Adaptamos el cálculo de este indicador. Si los hogares no tienen más de uno de los siguientes activos: 1)TV, 5) Computadora/laptop/tableta, 6) Teleofono celular, 10) Refrigeradora

# PREPROCESSING
df_household <- df_household  |>
  dplyr::mutate(P113_1 = ifelse(P113_1==2,0,P113_1)) |>
  dplyr::mutate(P113_2 = ifelse(P113_2==2,0,P113_2)) |>
  dplyr::mutate(P113_3 = ifelse(P113_3==2,0,P113_3)) |>
  dplyr::mutate(P113_4 = ifelse(P113_4==2,0,P113_4)) |>
  dplyr::mutate(P113_5 = ifelse(P113_5==2,0,P113_5)) |>
  dplyr::mutate(P113_6 = ifelse(P113_6==2,0,P113_6)) |>
  dplyr::mutate(P113_7 = ifelse(P113_7==2,0,P113_7)) |>
  dplyr::mutate(P113_8 = ifelse(P113_8==2,0,P113_8)) |>
  dplyr::mutate(P113_9 = ifelse(P113_9==2,0,P113_9)) |>
  dplyr::mutate(P113_10 = ifelse(P113_10==2,0,P113_10))

# Creación de un indicador compuesto que resume la tenencia de: 
#ENPOVE 2022 1) TV; 5) Computadora / laptop / tableta; 14) Teléfono (fijo o móvil); 8) Radio; 9) Refrigeradora/congeladora

#ENPOVE 2018: 1) TV; 5) Computadora / laptop / tableta; 6) Teleofono celular;                  10) Refrigeradora
df_household <- df_household  |>
  dplyr::mutate(P113 = P113_1 + P113_5 + P113_6 + P113_10)
...
# Household roster ENPOVE 2018

```{r df_household_roster enpove 2018, echo=FALSE, cache=FALSE}
...
df_household_roster <- df_household_roster |>
          dplyr::mutate(school_attendance = dplyr::case_when(
            P205_A > 18  | 
            (P205_A > 2 & P205_A < 18 & P505 == 1) ~ 1,   TRUE ~ 0   ) )
df_household_roster$school_attendance  <- labelled::labelled(df_household_roster$school_attendance,
  labels = c( 'Deprived' = 0, 'Not Deprived' = 1 ),
  label = "Education  |	School attendance")
  #label = "INDICADOR 12: Escolaridad infantil (NNA entre 3 y 18 años matriculados en la escuela")
    ...
    if(lengths(data_roster.val[i]) > 0) {
      ...
      p <-   sjPlot::plot_xtab(x= data_roster[[i]],
        ...
        labs(title = stringr::str_wrap(paste0(varlab) , 70),
             ...
             x = "",
             y = "",
             caption = "Source: ENPOVE 2018 inei.gob.pe microdatos")
    } else {
...
#Household preprocessing ENAHO 2022

```{r df_household_preprocessing_enaho_2022, eval=FALSE, include=FALSE}
##Preprocessing
#

#Loading ENAHO's 2022 at household level 
df_household_1 <- read_sav(here::here("data-raw","Enaho01-2022-100.sav"))

df_household_2 <- read_sav(here::here("data-raw","Enaho01-2022-200.sav"))

df_household_18 <- read_sav(here::here("data-raw","Enaho01-2022-612.sav"))


######## DEPURACIÓN DE FILAS 

# filter out of the analysis the HH where the survey was other than complete and incomplete.
df_household_1 <- df_household_1  |>
  dplyr::filter(RESULT <= 2)

# filter out of the analysis the people that where not regular members of the household and are not Homeworkers neither Pensioners 
df_household_2 <- df_household_2  |>
  dplyr::filter(P204==1 & P203!=8 & P203!=9 )

# Create the variable ambito geografico in order to later filter out rural HH's
df_household_1 <- df_household_1 |>
  dplyr::mutate(AMBITO = dplyr::case_when(
    ESTRATO %in% c(1:5) ~ 1,   TRUE ~ 0   ) )
df_household_1$AMBITO  <- labelled::labelled(df_household_1$AMBITO,
  labels = c( 'Rural' = 0, 'Urbano' = 1 ),
  label = "Ambito geográfico (Urbano | Rural)")  

df_household_2 <- df_household_2 |>
  dplyr::mutate(AMBITO = dplyr::case_when(
    ESTRATO %in% c(1:5) ~ 1,   TRUE ~ 0   ) )
df_household_2$AMBITO  <- labelled::labelled(df_household_2$AMBITO,
  labels = c( 'Rural' = 0, 'Urbano' = 1 ),
  label = "Ambito geográfico (Urbano | Rural)")  

# filter out rural Households
df_household_1 <- df_household_1  |>
  dplyr::filter(AMBITO == 1)

df_household_2 <- df_household_2  |>
  dplyr::filter(AMBITO == 1)


######## CREATE UNIQUE RESIDENCE/DWELLING ID
df_household_1 <- df_household_1  |>
  dplyr::mutate(CODIGO_VIVIENDA = paste0(CONGLOME, VIVIENDA))
df_household_1$CODIGO_VIVIENDA  <- labelled::labelled(df_household_1$CODIGO_VIVIENDA,
  label = "Codigo de Vivienda") 

df_household_2 <- df_household_2  |>
  dplyr::mutate(CODIGO_VIVIENDA = paste0(CONGLOME, VIVIENDA))
df_household_2$CODIGO_VIVIENDA  <- labelled::labelled(df_household_2$CODIGO_VIVIENDA,
  label = "Codigo de Vivienda") 

df_household_18 <- df_household_18  |>
  dplyr::mutate(CODIGO_VIVIENDA = paste0(CONGLOME, VIVIENDA))
df_household_18$CODIGO_VIVIENDA  <- labelled::labelled(df_household_18$CODIGO_VIVIENDA,
  label = "Codigo de Vivienda") 


######## CREATE UNIQUE HOUSEHOLD ID
df_household_1 <- df_household_1  |>
  dplyr::mutate(uuid = paste0(CONGLOME, VIVIENDA, HOGAR))
df_household_1$uuid  <- labelled::labelled(df_household_1$uuid,
  label = "Codigo de hogar") 

df_household_2 <- df_household_2  |>
  dplyr::mutate(uuid = paste0(CONGLOME, VIVIENDA, HOGAR))
df_household_2$uuid  <- labelled::labelled(df_household_2$uuid,
  label = "Codigo de hogar") 

df_household_18 <- df_household_18  |>
  dplyr::mutate(uuid = paste0(CONGLOME, VIVIENDA, HOGAR))
df_household_18$uuid  <- labelled::labelled(df_household_18$uuid,
  label = "Codigo de hogar") 


######## CREATE UNIQUE PERSON ID
df_household_2 <- df_household_2  |>
  dplyr::mutate(CODIGO_PERSONA = paste0(uuid,CODPERSO))
df_household_2$CODIGO_PERSONA  <- labelled::labelled(df_household_2$CODIGO_PERSONA,
  label = "Codigo de hogar") 


# select variables from the different datasets
df_household_1 <- df_household_1  |>
  select(AÑO,MES,CONGLOME,VIVIENDA,HOGAR,UBIGEO,DOMINIO,ESTRATO,PERIODO,TIPENC,RESULT,
         PANEL,CODIGO_VIVIENDA,uuid,P101,P102,P103A,P103,P104,P104A,
         P105A,P110,P111A,P1121,P1123,P1124,P1125,P1126,P1127,P112A,
         P1131,P1132,P1133,P1135,P1136,P1139,P1137,P1138,P113A,P1141,P1142,P1143,
         P1144,P1145,T110,P200I,P600I,P700I,P710I,P800I,T110,T111A,
         NCONGLOME,SUB_CONGLOME,CODCCPP,NOMCCPP,NBI1,NBI2,NBI3,NBI4,NBI5,FACTOR07)

df_household_2 <- df_household_2  |>
  select(AÑO,MES,CONGLOME,VIVIENDA,HOGAR,CODPERSO,UBIGEO,DOMINIO,ESTRATO,
         CODIGO_VIVIENDA,uuid,CODIGO_PERSONA,P201P,P203,P203A,P203B,P204,
         P205,P206,P207,P208A,P208B,P209,P212,P213,NCONGLOME,SUB_CONGLOME,
         FACPOB07)

df_household_18 <- df_household_18 %>%
  select(uuid,P612N,P612)


# Rename the variables to have less editing in the code
df_household_1 <- df_household_1  |>
  rename(P107 = P105A,
         P106 = P104A,
         P105 = P104,
...
#bringing back the lost labels 
columns_to_label <- c("P101", "P102", "P103", "P104", "P105", "P106")
for (col in columns_to_label) {
  df_household_1[[col]] <- labelled::labelled(df_household_1[[col]], label = switch(
    col,
    P101 = "Tipo de vivienda:",
    P102 = "El material predominante en las paredes exteriores es:",
    P103 = "El material predominante en los techos es:",
    P104 = "El material predominante en los pisos es:",
    P105 = "¿Cuántas habitaciones en total tiene la vivienda, sin contar el baño, la cocina, los pasadizos, ni el garage?",
    P106 = "¿Cuántas habitaciones se usan exclusivamente para dormir?",
  ))
}

#pivot the long asset dataset because it was organized at 28 items assessed per Household  
df_household_18 <- df_household_18 |>
  pivot_wider(names_from = P612N, 
              values_from = P612) |>
  rename_with(~ paste0("P612_", .x), matches("[0-9]+"))
df_household_18$P612_1  <- labelled::labelled(df_household_18$P612_1,
  label = "En su hogar tiene: Radio")
df_household_18$P612_2  <- labelled::labelled(df_household_18$P612_2,
  label = "En su hogar tiene: TV a color")
df_household_18$P612_7  <- labelled::labelled(df_household_18$P612_7,
  label = "En su hogar tiene: Computadora/Laptop")
df_household_18$P612_12  <- labelled::labelled(df_household_18$P612_12,
  label = "En su hogar tiene: Refrigeradora/Congeladora")
df_household_18$P612_28  <- labelled::labelled(df_household_18$P612_28,
  label = "En su hogar tiene: Tablet")



#keep variables ASSETS: "P612_1. Radio" "P612_2. Tv a color" "P612_7. Computadora/laptop" "P612_12. Refrigeradora/congeladora" "P612_28. Tablet"
df_household_18 <- df_household_18 |>
  select(uuid,P612_1,P612_2,P612_7,P612_12,P612_28)

#backup
#df_household_2a <- df_household_2 

#group by household to create the variables for Total number of household members 
df_household_2 <- df_household_2  |>
  group_by(uuid)  |>
  summarise(P15_N = n(),
            #P207_sum = sum(P207, na.rm = TRUE),
...
#merge data at the household level
df_household <- merge(df_household_1, df_household_2,  by = "uuid")
df_household <- merge(df_household, df_household_18,  by = "uuid")
...
#Household ENAHO 2022

```{r df_household_indicator_enaho_2022}
...
# PREPROCESSING
df_household <- df_household  |>
  dplyr::mutate(P612_1 = ifelse(P612_1==2,0,P612_1)) |>
  dplyr::mutate(P612_2 = ifelse(P612_2==2,0,P612_2)) |>
  dplyr::mutate(P612_7 = ifelse(P612_7==2,0,P612_7)) |>
  dplyr::mutate(P612_12 = ifelse(P612_12==2,0,P612_12)) |>
  dplyr::mutate(P612_28 = ifelse(P612_28==2,0,P612_28))

# Creación de un indicador compuesto que resume la tenencia de: 
#ENPOVE 2022: 1) TV; 5) Computadora / laptop / tableta; 14) Teléfono (fijo o móvil); 8) Radio; 9) Refrigeradora/congeladora
#ENPOVE 2018: 1) TV; 5) Computadora / laptop / tableta; 6) Teleofono celular;                  10) Refrigeradora
#ENAHO 2022: 1) Radio; 2) TV a color; 7) Computadora/laptop; 12) Regrigeradora/congeladora 28) Tablet


# Creación de variable tenencia de algún tipo de teléfono (fijo o móvil)
# P612_14 = P1141 (Su hogar tiene teléfono fijo) or P1142 (Su hogar tiene teléfono celular)
df_household <- df_household |>
          dplyr::mutate(P612_14 = dplyr::case_when(
            P1141 == 1 | P1142 == 1 ~ 1,   TRUE ~ 0   ) )

# Creación de variable tenencia de Computadora/Laptop/Tablet
# P612_5 = P612_7 (Su hogar tiene Computadora/Laptop) or P612_28 (Su hogar tiene Tablet)
df_household <- df_household |>
          dplyr::mutate(P612_5 = dplyr::case_when(
            P612_7 == 1 | P612_28 == 1 ~ 1,   TRUE ~ 0   ) )

# Create the variable number of assets
df_household <- df_household  |>
  dplyr::mutate(P612 = P612_1 + P612_2 + P612_5 + P612_12 + P612_14)
...
#Household roster preprocessing ENAHO 2022


```{r df_household_roster_enaho_2022}

df_household_4 <- read_sav(here::here("data-raw","Enaho01A-2022-400.sav"))

######## DEPURACIÓN DE FILAS 

# We filter out of the analysis the HH where the survey was other than complete and incomplete.
df_household_1 <- df_household_1  |>
  dplyr::filter(RESULT <= 2)

# Create the variable ambito geografico in order to later filter out rural HH's
df_household_4 <- df_household_4 |>
  dplyr::mutate(AMBITO = dplyr::case_when(
    ESTRATO %in% c(1:5) ~ 1,   TRUE ~ 0   ) )
df_household_4$AMBITO  <- labelled::labelled(df_household_4$AMBITO,
  labels = c( 'Rural' = 0, 'Urbano' = 1 ),
  label = "Ambito geográfico (Urbano | Rural)")  
...
# Extract common and unique column names
common_cols <- Reduce(intersect, lapply(list(names(df_household_1), names(df_household_2), names(df_household_2a), names(df_household_18)), as.vector))

diff_cols_df1 <- setdiff(names(df_household_1), common_cols)
diff_cols_df2 <- setdiff(names(df_household_2), common_cols)
diff_cols_df2a <- setdiff(names(df_household_2a), common_cols)
diff_cols_df18 <- setdiff(names(df_household_18), common_cols)
