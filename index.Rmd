...
#bringing back the labels 
df_household_1$P101  <- labelled::labelled(df_household_1$P101,
  label = "TIPO DE VIVIENDA:")
df_household_1$P102  <- labelled::labelled(df_household_1$P102,
  label = "¿EL MATERIAL DE CONSTRUCCIÓN PREDOMINANTE EN LAS PAREDES EXTERIORES ES:")  
df_household_1$P103  <- labelled::labelled(df_household_1$P103,
  label = "¿EL MATERIAL DE CONSTRUCCIÓN PREDOMINANTE EN LOS TECHOS ES:")
df_household_1$P104  <- labelled::labelled(df_household_1$P104,
  label = "¿EL MATERIAL DE CONSTRUCCIÓN PREDOMINANTE EN LOS PISOS ES:")  
df_household_1$P105  <- labelled::labelled(df_household_1$P105,
  label = "¿CUÁNTAS HABITACIONES EN TOTAL TIENE LA VIVIENDA, SIN CONTAR EL BAÑO, LA COCINA, LOS PASADIZOS Y GARAGE?")
df_household_1$P106  <- labelled::labelled(df_household_1$P106,
  label = "¿CUÁNTAS HABITACIONES SE USAN EXCLUSIVAMENTE  PARA DORMIR?")  
df_household_1$P107  <- labelled::labelled(df_household_1$P107,
  label = "¿CUÁNTOS GRUPOS DE PERSONAS, INCLUYENDO EL SUYO; COMPARTEN ESTA VIVIENDA PERO COCINAN SUS ALIMENTOS POR SEPARADO?") 
df_household_1$P105N  <- labelled::labelled(df_household_1$P105N,
...
df_household_1<-df_household_1 |>
  mutate(CIUDADES_DE_ESTUDIO = recode(CIUDADES_DE_ESTUDIO, 
                                      ...
                                      '8' = 'Trujillo',
                                      '9' = 'Tumbes'))
df_household_1$CIUDADES_DE_ESTUDIO  <- labelled::labelled(df_household_1$CIUDADES_DE_ESTUDIO,
  label = "CIUDADES DE ESTUDIO")
...
df_household_2a<-df_household_2a |>
  mutate(CIUDADES_DE_ESTUDIO = recode(CIUDADES_DE_ESTUDIO, 
                                      ...
                                      '8' = 'Trujillo',
                                      '9' = 'Tumbes'))
df_household_2a$CIUDADES_DE_ESTUDIO  <- labelled::labelled(df_household_2a$CIUDADES_DE_ESTUDIO,
  label = "CIUDADES DE ESTUDIO")
...
df_household_4<-df_household_4 |>
  mutate(CIUDADES_DE_ESTUDIO = recode(CIUDADES_DE_ESTUDIO, 
                                      ...
                                      '8' = 'Trujillo',
                                      '9' = 'Tumbes'))
df_household_4$CIUDADES_DE_ESTUDIO  <- labelled::labelled(df_household_4$CIUDADES_DE_ESTUDIO,
  label = "CIUDADES DE ESTUDIO")

df_household_5<-df_household_5 |>
  mutate(CIUDADES_DE_ESTUDIO = recode(CIUDADES_DE_ESTUDIO, 
                                      '1' = 'Lima Norte',
                                      '2' = 'Lima Este',
                                      '3' = 'Lima Centro',
                                      ...
                                      '8' = 'Trujillo',
                                      '9' = 'Tumbes'))
df_household_5$CIUDADES_DE_ESTUDIO  <- labelled::labelled(df_household_5$CIUDADES_DE_ESTUDIO,
  label = "CIUDADES DE ESTUDIO")

df_household_6<-df_household_6 |>
  mutate(CIUDADES_DE_ESTUDIO = recode(CIUDADES_DE_ESTUDIO, 
                                      '1' = 'Lima Norte',
                                      '2' = 'Lima Este',
                                      '3' = 'Lima Centro',
                                      ...
                                      '8' = 'Trujillo',
                                      '9' = 'Tumbes'))
df_household_6$CIUDADES_DE_ESTUDIO  <- labelled::labelled(df_household_6$CIUDADES_DE_ESTUDIO,
  label = "CIUDADES DE ESTUDIO")
...
#Filtering out the Households without venezuelan people
# df_household_2 <- df_household_2  |>
#   dplyr::filter(P207_sum > 0)

# df_household_2 <- df_household_2  |>
#   dplyr::filter(P205_A > 2)

# df_household_2 <- df_household_2  |>
#   dplyr::filter(HOGAR < 20)
