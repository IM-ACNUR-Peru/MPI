...
# creation of the variable Cooking Fuel based on the answers to "What fuel do you use most frequently at home for cooking?
df_household_1 <- df_household_1 |>
          dplyr::mutate(P113 = dplyr::case_when(
            P113A %in% c(1:3) ~ 1,   TRUE ~ 0   ) )
df_household_1$P113  <- labelled::labelled(df_household_1$P113,
  labels = c( 'Carbón|Leña|Bosta, estiercol|Otro' = 0, 'Electricidad|Gas (balón GLP)|Gas natural' = 1 ),
  label = "Combustible que usan en el hogar para cocinar con mayor frecuencia")
