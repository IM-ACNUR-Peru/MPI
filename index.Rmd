...
:::{.lead}
This document presents an analysis of multidimensional poverty in Peru using the ENPOVE 2018 and 2022 and comparing results with ENAHO 2022.
:::
...
# Household Roster Preprocessing
...
```{r df_household_roster preprocessing, echo=FALSE, cache = TRUE}
...
df_household_roster <- df_household_roster |>
          dplyr::mutate(year_schooling = dplyr::case_when(
            P205_A >17 & (P501 %in% c(6:11) | P501B %in% c(6:12)) ~ 1,   TRUE ~ 0   ) )
